    ...
    513: function (e, t, n) {
        ...
        if (e)
          if ("string" == typeof e) {
            ...
            if (html.indexOf("<") >= 0 && html.indexOf(">") >= 0) {
              let e = "div";
              for (
                0 === html.indexOf("<li") && (e = "ul"),
                  0 === html.indexOf("<tr") && (e = "tbody"),
                  (0 !== html.indexOf("<td") && 0 !== html.indexOf("<th")) ||
                    (e = "tr"),
                  0 === html.indexOf("<tbody") && (e = "table"),
                  0 === html.indexOf("<option") && (e = "select"),
                  l = o.createElement(e),
                  l.innerHTML = html,
                  i = 0;
      ...
      const v = {
        ...
        on: function (...e) {
          ...
          "function" == typeof e[1] && (([t, r, l] = e), (n = void 0)),
            l || (l = !1);
          const c = t.split(" ");
          let h;
          for (let i = 0; i < this.length; i += 1) {
          ...
          for (let i = 0; i < o.length; i += 1) {
            ...
            for (let t = 0; t < this.length; t += 1) {
              ...
              if (
                (!n && o.dom7Listeners
                  ? (d = o.dom7Listeners[e])
                  : n && o.dom7LiveListeners && (d = o.dom7LiveListeners[e]),
                d && d.length)
              )
                for (let t = d.length - 1; t >= 0; t -= 1) {
                  ...
                  (r &&
                    ...
                    ? (o.removeEventListener(e, n.proxyListener, l),
                      d.splice(t, 1))
                    : r ||
                      (o.removeEventListener(e, n.proxyListener, l),
                      d.splice(t, 1));
        ...
        trigger: function (...e) {
          ...
          for (let i = 0; i < t.length; i += 1) {
            ...
            for (let t = 0; t < this.length; t += 1) {
              ...
              (l.dom7EventData = e.filter((data, e) => e > 0)),
                l.dispatchEvent(d),
                (l.dom7EventData = []),
        ...
        offset: function () {
          if (this.length > 0) {
            ...
            return { top: t.top + l - n, left: t.left + d - r };
          }
          return null;
        },
        css: function (e, t) {
        ...
        children: function (e) {
          ...
          for (let i = 0; i < this.length; i += 1) {
            ...
            for (let r = 0; r < n.length; r += 1)
              e
                ? 1 === n[r].nodeType && m(n[r]).is(e) && t.push(n[r])
      ...
      const w = {
                ...
                ? ((r = o.transform || o.webkitTransform),
                  r.split(",").length > 6 &&
                    (r = r
                      ...
                      .map((a) => a.replace(",", "."))
                      .join(", ")),
                  (l = new c.WebKitCSSMatrix("none" === r ? "" : r)))
                : ((l =
                    o.MozTransform ||
                    o.OTransform ||
                    o.MsTransform ||
            ...
            for (let i = 1; i < e.length; i += 1) {
              ...
              if (null != n) {
                ...
                for (let r = 0, l = e.length; r < l; r += 1) {
                  ...
                  void 0 !== desc &&
                    desc.enumerable &&
                    (w.isObject(t[l]) && w.isObject(n[l])
                      ? w.extend(t[l], n[l])
                      : !w.isObject(t[l]) && w.isObject(n[l])
                      ? ((t[l] = {}), w.extend(t[l], n[l]))
                      : (t[l] = n[l]));
                }
              }
            }
        ...
        y = {
          touch: !!(
            "ontouchstart" in c ||
            (c.DocumentTouch && o instanceof c.DocumentTouch)
          ),
          pointerEvents:
            !!c.PointerEvent &&
      ...
      var E = {
        ...
        updateSlides: function () {
          const e = this,
            t = e.params,
            { $wrapperEl: n, size: r, rtlTranslate: l, wrongRTL: o } = e,
                ...
                const e = Math.floor(
                  ...
                  c =
                    0 === e
                      ? t.slidesPerGroup
                      : Math.min(
                          Math.ceil((f - e * D * t.slidesPerGroup) / D),
                          t.slidesPerGroup
                        );
                (o = Math.floor(d / c)),
                  (l = d - o * c + e * t.slidesPerGroup),
                  (r = l + (o * M) / D),
                  n.css({
            ...
            if ("none" !== n.css("display")) {
              if ("auto" === t.slidesPerView) {
                ...
                if (
                  ...
                  P = e.isHorizontal() ? n.outerWidth(!0) : n.outerHeight(!0);
                ...
                (P = (r - (t.slidesPerView - 1) * z) / t.slidesPerView),
                  t.roundLengths && (P = Math.floor(P)),
                  m[i] &&
                    (e.isHorizontal()
                      ? (m[i].style.width = `${P}px`)
                      : (m[i].style.height = `${P}px`));
              m[i] && (m[i].swiperSlideSize = P),
                x.push(P),
                t.centeredSlides
                  ? ((k = k + P / 2 + L / 2 + z),
                    0 === L && 0 !== i && (k = k - r / 2 - z),
          ...
          if (
            ...
            t.slidesPerColumn > 1 &&
              ((e.virtualSize = (P + t.spaceBetween) * M),
              (e.virtualSize =
            ...
            for (let i = 0; i < v.length; i += 1) {
              ...
              t.roundLengths && (n = Math.floor(n)),
                v[i] < e.virtualSize + v[0] && G.push(n);
            }
            v = G;
          }
          if (!t.centeredSlides) {
          ...
          if (
            ...
            0 !== t.spaceBetween &&
              (e.isHorizontal()
                ? l
                  ? m.filter(E).css({ marginLeft: `${z}px` })
                  : m.filter(E).css({ marginRight: `${z}px` })
                : m.filter(E).css({ marginBottom: `${z}px` })),
          ...
          w.extend(e, {
            ...
            y.length !== $ && e.emit("slidesGridLengthChange"),
        ...
        updateProgress: function (e) {
          ...
          let { progress: progress, isBeginning: l, isEnd: o } = t;
          const d = l,
            c = o;
          0 === r
            ? ((progress = 0), (l = !0), (o = !0))
            : ((progress = (e - t.minTranslate()) / r),
              (l = progress <= 0),
              (o = progress >= 1)),
            w.extend(t, { progress: progress, isBeginning: l, isEnd: o }),
            (n.watchSlidesProgress ||
              n.watchSlidesVisibility ||
              (n.centeredSlides && n.autoHeight)) &&
              t.updateSlidesProgress(e),
            l && !d && t.emit("reachBeginning toEdge"),
            o && !c && t.emit("reachEnd toEdge"),
            ((d && !l) || (c && !o)) && t.emit("fromEdge"),
        ...
        updateSlidesClasses: function () {
          ...
          t.removeClass(
            ...
            (c = d
              ? e.$wrapperEl.find(
                  `.${n.slideClass}[data-swiper-slide-index="${l}"]`
                )
              : t.eq(l)),
        ...
        updateActiveIndex: function (e) {
          ...
          if ((m >= l.length && (m = l.length - 1), f === d))
            return void (
      ...
      var T = {
        ...
        setTranslate: function (e, t) {
          ...
          n.isHorizontal() ? (h = r ? -e : e) : (m = e),
            l.roundLengths && ((h = Math.floor(h)), (m = Math.floor(m))),
            l.cssMode
              ? (d[n.isHorizontal() ? "scrollLeft" : "scrollTop"] =
                  n.isHorizontal() ? -h : -m)
              : l.virtualTranslate ||
                o.transform(`translate3d(${h}px, ${m}px, 0px)`),
            (n.previousTranslate = n.translate),
            (n.translate = n.isHorizontal() ? h : m);
          const f = n.maxTranslate() - n.minTranslate();
          (c = 0 === f ? 0 : (e - n.minTranslate()) / f),
          ...
          return (
            0 === t
              ? (o.setTransition(0),
                o.setTranslate(f),
                n &&
                  (o.emit("beforeTransitionStart", t, l),
      ...
      var S = {
        ...
        transitionStart: function (e = !0, t) {
          const n = this,
            { activeIndex: r, params: l, previousIndex: o } = n;
          if (l.cssMode) return;
        ...
        transitionEnd: function (e = !0, t) {
          const n = this,
            { activeIndex: r, previousIndex: l, params: o } = n;
      ...
      var C = {
        slideTo: function (e = 0, t = this.params.speed, n = !0, r) {
          ...
          if ((l.updateProgress(E), d.normalizeSlideIndex))
            for (let i = 0; i < h.length; i += 1)
              -Math.floor(100 * E) >= Math.floor(100 * h[i]) && (o = i);
          ...
          let T;
          if (
            ((T = o > f ? "next" : o < f ? "prev" : "reset"),
            (v && -E === l.translate) || (!v && E === l.translate))
          )
            return (
              l.updateActiveIndex(o),
              d.autoHeight && l.updateAutoHeight(),
              l.updateSlidesClasses(),
              "slide" !== d.effect && l.setTranslate(E),
              "reset" !== T && (l.transitionStart(n, T), l.transitionEnd(n, T)),
              !1
            );
          if (d.cssMode) {
        ...
        slideToClosest: function (e = this.params.speed, t = !0, n, r = 0.5) {
          ...
          if (h >= l.snapGrid[c]) {
            ...
            h - e > (l.snapGrid[c + 1] - e) * r &&
              (o += l.params.slidesPerGroup);
          } else {
          ...
          return (
            (o = Math.max(o, 0)),
            (o = Math.min(o, l.slidesGrid.length - 1)),
            l.slideTo(o, e, t, n)
          );
        },
        ...
        loopCreate: function () {
          ...
          if (t.loopFillGroupWithBlank) {
            ...
            if (e !== t.slidesPerGroup) {
              for (let i = 0; i < e; i += 1) {
                const e = m(o.createElement("div")).addClass(
          ...
          r.each((t, n) => {
            ...
            t < e.loopedSlides && d.push(n),
              t < r.length && t >= r.length - e.loopedSlides && l.push(n),
              o.attr("data-swiper-slide-index", t);
          });
          for (let i = 0; i < d.length; i += 1)
            n.append(m(d[i].cloneNode(!0)).addClass(t.slideDuplicateClass));
          for (let i = l.length - 1; i >= 0; i -= 1)
            n.prepend(m(l[i].cloneNode(!0)).addClass(t.slideDuplicateClass));
        },
        loopFix: function () {
          const e = this;
      ...
      var P = {
        ...
        prependSlide: function (e) {
          const t = this,
            { params: n, $wrapperEl: r, activeIndex: l } = t;
        ...
        addSlide: function (e, t) {
          const n = this,
            { $wrapperEl: r, params: l, activeIndex: o } = n;
          let d = o;
          l.loop &&
            ((d -= n.loopedSlides),
            n.loopDestroy(),
            (n.slides = r.children(`.${l.slideClass}`)));
          ...
          l.loop && n.loopCreate(),
            (l.observer && y.observer) || n.update(),
            l.loop ? n.slideTo(h + n.loopedSlides, 0, !1) : n.slideTo(h, 0, !1);
        },
        ...
        if (!v || !(h <= y || h >= c.screen.width - y)) {
          if (
            ...
            d.is(data.formElements) && (e = !1),
              o.activeElement &&
                m(o.activeElement).is(data.formElements) &&
                o.activeElement !== d[0] &&
      ...
      function L(e) {
        const t = this,
          data = t.touchEventsData,
          { params: n, touches: r, rtlTranslate: l } = t;
        let d = e;
        ...
        if (f > n.longSwipesMs) {
          ...
          (h.target === t.navigation.nextEl || h.target === t.navigation.prevEl)
            ? h.target === t.navigation.nextEl
              ? t.slideTo(y + T)
              : t.slideTo(y)
            : ("next" === t.swipeDirection && t.slideTo(y + T),
      ...
      function D() {
        ...
        const { allowSlideNext: r, allowSlidePrev: l, snapGrid: o } = e;
        (e.allowSlideNext = !0),
          (e.allowSlidePrev = !0),
          e.updateSize(),
          e.updateSlides(),
      ...
      function A() {
        ...
        (r = 0 === l ? 0 : (e.translate - e.minTranslate()) / l),
      ...
      const N = {
          ...
          events: {
            attachEvents: function () {
              const e = this,
                { params: t, touchEvents: n, el: r, wrapperEl: l } = e;
              ...
              if (!y.touch && y.pointerEvents)
                r.addEventListener(n.start, e.onTouchStart, !1),
                  o.addEventListener(n.move, e.onTouchMove, d),
                ...
                if (y.touch) {
                  ...
                  r.addEventListener(n.start, e.onTouchStart, l),
                    r.addEventListener(
                      n.move,
                      e.onTouchMove,
                      y.passiveListener ? { passive: !1, capture: d } : d
                    ),
                    r.addEventListener(n.end, e.onTouchEnd, l),
                    n.cancel && r.addEventListener(n.cancel, e.onTouchEnd, l),
                    G || (o.addEventListener("touchstart", H), (G = !0));
                }
                ((t.simulateTouch && !z.ios && !z.android) ||
                  (t.simulateTouch && !y.touch && z.ios)) &&
                  (r.addEventListener("mousedown", e.onTouchStart, !1),
                  o.addEventListener("mousemove", e.onTouchMove, d),
            ...
            detachEvents: function () {
              ...
              if (!y.touch && y.pointerEvents)
                r.removeEventListener(n.start, e.onTouchStart, !1),
                  o.removeEventListener(n.move, e.onTouchMove, d),
                ...
                if (y.touch) {
                  ...
                  r.removeEventListener(n.start, e.onTouchStart, l),
                    r.removeEventListener(n.move, e.onTouchMove, d),
                    r.removeEventListener(n.end, e.onTouchEnd, l),
                    n.cancel &&
                      r.removeEventListener(n.cancel, e.onTouchEnd, l);
                }
                ((t.simulateTouch && !z.ios && !z.android) ||
                  (t.simulateTouch && !y.touch && z.ios)) &&
                  (r.removeEventListener("mousedown", e.onTouchStart, !1),
                  o.removeEventListener("mousemove", e.onTouchMove, d),
                  o.removeEventListener("mouseup", e.onTouchEnd, !1));
              }
              (t.preventClicks || t.preventClicksPropagation) &&
                r.removeEventListener("click", e.onClick, !0),
                t.cssMode && l.removeEventListener("scroll", e.onScroll),
                e.off(
                  z.ios || z.android
                    ? "resize orientationchange observerUpdate"
                    : "resize observerUpdate",
          ...
          breakpoints: {
            setBreakpoint: function () {
              ...
              if (c && e.currentBreakpoint !== c) {
                ...
                f && !v
                  ? o.removeClass(
                      `${l.containerModifierClass}multirow ${l.containerModifierClass}multirow-column`
                    )
                  : !f &&
                    v &&
                    (o.addClass(`${l.containerModifierClass}multirow`),
                    "column" === m.slidesPerColumnFill &&
                      o.addClass(`${l.containerModifierClass}multirow-column`));
          ...
          images: {
            loadImage: function (e, t, n, r, l, o) {
              ...
              m(e).parent("picture")[0] || (e.complete && l)
                ? d()
                : t
                ? ((image = new c.Image()),
                  (image.onload = d),
      ...
      class V extends x {
        constructor(...e) {
          ...
          const l = w.extend({}, B);
          r.useModulesParams(l),
            (r.params = w.extend({}, l, X, n)),
        ...
        slidesPerViewDynamic() {
          ...
          if (e.centeredSlides) {
            let e,
              n = t[l].swiperSlideSize;
            for (let i = l + 1; i < t.length; i += 1)
              t[i] &&
                !e &&
                ((n += t[i].swiperSlideSize), (o += 1), n > r && (e = !0));
        ...
        destroy(e = !0, t = !0) {
          const n = this,
            { params: r, $el: l, $wrapperEl: o, slides: d } = n;
          return (
            void 0 === n.params ||
              n.destroyed ||
      ...
      var Y = { name: "device", proto: { device: z }, static: { device: z } },
        F = { name: "support", proto: { support: y }, static: { support: y } };
      const W = {
      ...
      const _ = {
        update(e) {
          const t = this,
            ...
            { addSlidesBefore: o, addSlidesAfter: d } = t.params.virtual,
            {
              from: c,
              to: h,
              slides: m,
      ...
      const Z = {
        ...
        enable() {
          const e = this;
          e.keyboard.enabled ||
            (m(o).on("keydown", e.keyboard.handle), (e.keyboard.enabled = !0));
        },
        disable() {
          const e = this;
          e.keyboard.enabled &&
            (m(o).off("keydown", e.keyboard.handle), (e.keyboard.enabled = !1));
        },
      };
      var Q = {
        name: "keyboard",
      ...
      const ee = {
        ...
        normalize(e) {
          ...
          return (
            ...
            r && !t && (t = r < 1 ? -1 : 1),
            l && !n && (n = l < 1 ? -1 : 1),
            { spinX: t, spinY: n, pixelX: r, pixelY: l }
          );
        },
        handleMouseEnter() {
          this.mouseEntered = !0;
        ...
        handle(e) {
          ...
          if (
            ...
            !n.mouseEntered && !l[0].contains(t.target) && !r.releaseOnEdges)
          )
            return !0;
          ...
          if ((r.invert && (o = -o), n.params.freeMode)) {
            const e = {
              ...
              { lastEventBeforeSnap: l } = n.mousewheel,
              d =
                l &&
                e.time < l.time + 500 &&
                e.delta <= l.delta &&
        ...
        update() {
          ...
          if (
            (e.params.loop
              ? ((o = Math.ceil(
                ...
                o > d - 1 && (o -= d),
                o < 0 && "bullets" !== e.params.paginationType && (o = d + o))
            ...
            if (
                ...
                n.dynamicMainBullets > 1 &&
                  ...
                  e.pagination.dynamicBulletIndex > n.dynamicMainBullets - 1
                    ...
                    : e.pagination.dynamicBulletIndex < 0 &&
                      (e.pagination.dynamicBulletIndex = 0)),
                (d = o - e.pagination.dynamicBulletIndex),
              ...
              r.each((e, t) => {
                const r = m(t),
                  l = r.index();
                l === o && r.addClass(n.bulletActiveClass),
                  n.dynamicBullets &&
                    (l >= d &&
                      l <= c &&
            ...
            if (n.dynamicBullets) {
              const l = Math.min(r.length, n.dynamicMainBullets + 4),
                o =
                  (e.pagination.bulletSize * l - e.pagination.bulletSize) / 2 -
          ...
          if (
            ("fraction" === n.type &&
              ...
              l.find(`.${n.totalClass}`).text(n.formatFractionTotal(d))),
            "progressbar" === n.type)
          ) {
            let t;
          ...
          "custom" === n.type && n.renderCustom
            ? (l.html(n.renderCustom(e, o + 1, d)),
              e.emit("paginationRender", e, l[0]))
            : e.emit("paginationUpdate", e, l[0]),
            l[
              e.params.watchOverflow && e.isLocked ? "addClass" : "removeClass"
            ](n.lockClass);
        },
      ...
      const ae = {
        setTranslate() {
          ...
          const { scrollbar: t, rtlTranslate: n, progress: progress } = e,
            { dragSize: r, trackSize: l, $dragEl: o, $el: d } = t,
            c = e.params.scrollbar;
          let h = r,
            m = (l - r) * progress;
          n
            ? ((m = -m),
              m > 0 ? ((h = r - m), (m = 0)) : -m + r > l && (h = l + m))
            : m < 0
            ? ((h = r + m), (m = 0))
            : m + r > l && (h = l - m),
            e.isHorizontal()
              ? (o.transform(`translate3d(${m}px, 0, 0)`),
                (o[0].style.width = `${h}px`))
              : (o.transform(`translate3d(0px, ${m}px, 0)`),
        ...
        setDragPosition(e) {
          const t = this,
            ...
            { $el: l, dragSize: o, trackSize: d, dragStartPos: c } = n;
          let h;
          (h =
            (n.getPointerPosition(e) -
              l.offset()[t.isHorizontal() ? "left" : "top"] -
              (null !== c ? c : o / 2)) /
            (d - o)),
            (h = Math.max(Math.min(h, 1), 0)),
            r && (h = 1 - h);
          const m =
            t.minTranslate() + (t.maxTranslate() - t.minTranslate()) * h;
          t.updateProgress(m),
            t.setTranslate(m),
            t.updateActiveIndex(),
            t.updateSlidesClasses();
        ...
        enableDraggable() {
          ...
          const {
            ...
            d = t.$el[0],
            c = !(!y.passiveListener || !l.passiveListeners) && {
              passive: !1,
              capture: !1,
            },
          ...
          y.touch
            ...
            : (d.addEventListener(r.start, e.scrollbar.onDragStart, c),
              o.addEventListener(r.move, e.scrollbar.onDragMove, c),
              o.addEventListener(r.end, e.scrollbar.onDragEnd, h));
        },
        disableDraggable() {
          const e = this;
          if (!e.params.scrollbar.el) return;
          ...
          y.touch
            ...
            : (d.removeEventListener(r.start, e.scrollbar.onDragStart, c),
              o.removeEventListener(r.move, e.scrollbar.onDragMove, c),
              o.removeEventListener(r.end, e.scrollbar.onDragEnd, h));
        },
        init() {
          const e = this;
          if (!e.params.scrollbar.el) return;
          ...
          0 === o.length &&
            ((o = m(`<div class="${e.params.scrollbar.dragClass}"></div>`)),
            l.append(o)),
            w.extend(t, { $el: l, el: l[0], $dragEl: o, dragEl: o[0] }),
      ...
      const ie = {
        setTransform(e, progress) {
          ...
          if (
            ...
            (l =
              l.indexOf("%") >= 0
                ? parseInt(l, 10) * progress * r + "%"
                : l * progress * r + "px"),
            (o =
              o.indexOf("%") >= 0
                ? parseInt(o, 10) * progress + "%"
                : o * progress + "px"),
            null != c)
          ) {
        ...
        setTranslate() {
          const e = this,
            { $el: t, slides: n, progress: progress, snapGrid: r } = e;
          t
            .children(
            ...
            n.each((t, n) => {
              ...
              e.params.slidesPerGroup > 1 &&
                "auto" !== e.params.slidesPerView &&
                (l += Math.ceil(t / 2) - progress * (r.length - 1)),
      ...
      const ne = {
        ...
        onGestureStart(e) {
          ...
          if (
            ...
            (r.fakeGestureTouched = !0),
              (l.scaleStart = ne.getDistanceBetweenTouches(e));
          }
          (l.$slideEl && l.$slideEl.length) ||
          ((l.$slideEl = m(e.target).closest(`.${t.params.slideClass}`)),
          0 === l.$slideEl.length && (l.$slideEl = t.slides.eq(t.activeIndex)),
          (l.$imageEl = l.$slideEl.find(
            "img, svg, canvas, picture, .swiper-zoom-target"
          )),
          (l.$imageWrapEl = l.$imageEl.parent(`.${n.containerClass}`)),
          (l.maxRatio = l.$imageWrapEl.attr("data-swiper-zoom") || n.maxRatio),
          0 !== l.$imageWrapEl.length)
            ? (l.$imageEl && l.$imageEl.transition(0), (t.zoom.isScaling = !0))
            : (l.$imageEl = void 0);
        },
        onGestureChange(e) {
        ...
        onGestureEnd(e) {
          ...
          l.$imageEl &&
            0 !== l.$imageEl.length &&
            ((r.scale = Math.max(Math.min(r.scale, l.maxRatio), n.minRatio)),
            l.$imageEl
              .transition(t.params.speed)
              .transform(`translate3d(0,0,0) scale(${r.scale})`),
            (r.currentScale = r.scale),
            (r.isScaling = !1),
            1 === r.scale && (l.$slideEl = void 0));
        },
        onTouchStart(e) {
          const t = this.zoom,
            { gesture: n, image: image } = t;
          n.$imageEl &&
            0 !== n.$imageEl.length &&
            (image.isTouched ||
        ...
        onTouchMove(e) {
          const t = this,
            n = t.zoom,
            { gesture: r, image: image, velocity: l } = n;
          ...
          if (!(o < r.slideWidth && d < r.slideHeight)) {
            ...
            e.cancelable && e.preventDefault(),
              ...
              l.prevPositionX || (l.prevPositionX = image.touchesCurrent.x),
              l.prevPositionY || (l.prevPositionY = image.touchesCurrent.y),
              l.prevTime || (l.prevTime = Date.now()),
              (l.x =
                (image.touchesCurrent.x - l.prevPositionX) /
                (Date.now() - l.prevTime) /
                2),
              (l.y =
                (image.touchesCurrent.y - l.prevPositionY) /
                (Date.now() - l.prevTime) /
                2),
              Math.abs(image.touchesCurrent.x - l.prevPositionX) < 2 &&
                (l.x = 0),
              Math.abs(image.touchesCurrent.y - l.prevPositionY) < 2 &&
                (l.y = 0),
              (l.prevPositionX = image.touchesCurrent.x),
              (l.prevPositionY = image.touchesCurrent.y),
              (l.prevTime = Date.now()),
        ...
        onTouchEnd() {
          const e = this.zoom,
            { gesture: t, image: image, velocity: n } = e;
          ...
          0 !== n.x && (r = Math.abs((d - image.currentX) / n.x)),
            0 !== n.y && (l = Math.abs((h - image.currentY) / n.y));
        ...
        in(e) {
          const t = this,
            n = t.zoom,
            r = t.params.zoom,
            { gesture: l, image: image } = n;
          if (
            (l.$slideEl ||
              (t.params.virtual && t.params.virtual.enabled && t.virtual
                ? (l.$slideEl = t.$wrapperEl.children(
                    `.${t.params.slideActiveClass}`
                  ))
                : (l.$slideEl = t.slides.eq(t.activeIndex)),
              (l.$imageEl = l.$slideEl.find(
                "img, svg, canvas, picture, .swiper-zoom-target"
              )),
              (l.$imageWrapEl = l.$imageEl.parent(`.${r.containerClass}`))),
            !l.$imageEl || 0 === l.$imageEl.length)
          )
            return;
          let o, d, c, h, m, f, v, w, y, x, E, T, S, C, $, M, P, z;
          l.$slideEl.addClass(`${r.zoomedSlideClass}`),
            void 0 === image.touchesStart.x && e
              ? ((o =
                  "touchend" === e.type ? e.changedTouches[0].pageX : e.pageX),
                (d =
                  "touchend" === e.type ? e.changedTouches[0].pageY : e.pageY))
              : ((o = image.touchesStart.x), (d = image.touchesStart.y)),
            (n.scale = l.$imageWrapEl.attr("data-swiper-zoom") || r.maxRatio),
            (n.currentScale =
              l.$imageWrapEl.attr("data-swiper-zoom") || r.maxRatio),
            e
              ? ((P = l.$slideEl[0].offsetWidth),
                (z = l.$slideEl[0].offsetHeight),
                (c = l.$slideEl.offset().left),
                (h = l.$slideEl.offset().top),
                (m = c + P / 2 - o),
                (f = h + z / 2 - d),
                (y = l.$imageEl[0].offsetWidth),
                (x = l.$imageEl[0].offsetHeight),
                (E = y * n.scale),
                (T = x * n.scale),
                (S = Math.min(P / 2 - E / 2, 0)),
                (C = Math.min(z / 2 - T / 2, 0)),
                ($ = -S),
                (M = -C),
                (v = m * n.scale),
                (w = f * n.scale),
        ...
        enable() {
          ...
          const n = !(
            ...
            r = !y.passiveListener || { passive: !1, capture: !0 },
            l = `.${e.params.slideClass}`;
          y.gestures
            ? (e.$wrapperEl.on("gesturestart", l, t.onGestureStart, n),
              e.$wrapperEl.on("gesturechange", l, t.onGestureChange, n),
              e.$wrapperEl.on("gestureend", l, t.onGestureEnd, n))
            : "touchstart" === e.touchEvents.start &&
              (e.$wrapperEl.on(e.touchEvents.start, l, t.onGestureStart, n),
              e.$wrapperEl.on(e.touchEvents.move, l, t.onGestureChange, r),
              e.$wrapperEl.on(e.touchEvents.end, l, t.onGestureEnd, n),
              e.touchEvents.cancel &&
                e.$wrapperEl.on(e.touchEvents.cancel, l, t.onGestureEnd, n)),
            e.$wrapperEl.on(
              e.touchEvents.move,
        ...
        disable() {
          ...
          const n = !(
            ...
            l = `.${e.params.slideClass}`;
          y.gestures
            ? (e.$wrapperEl.off("gesturestart", l, t.onGestureStart, n),
              e.$wrapperEl.off("gesturechange", l, t.onGestureChange, n),
              e.$wrapperEl.off("gestureend", l, t.onGestureEnd, n))
            : "touchstart" === e.touchEvents.start &&
              (e.$wrapperEl.off(e.touchEvents.start, l, t.onGestureStart, n),
              e.$wrapperEl.off(e.touchEvents.move, l, t.onGestureChange, r),
              e.$wrapperEl.off(e.touchEvents.end, l, t.onGestureEnd, n),
              e.touchEvents.cancel &&
                e.$wrapperEl.off(e.touchEvents.cancel, l, t.onGestureEnd, n)),
            e.$wrapperEl.off(
              e.touchEvents.move,
              `.${e.params.zoom.containerClass}`,
              t.onTouchMove,
      ...
      const re = {
        loadInSlide(e, t = !0) {
          ...
          !l.hasClass(r.elementClass) ||
            l.hasClass(r.loadedClass) ||
            l.hasClass(r.loadingClass) ||
            (o = o.add(l[0])),
            0 !== o.length &&
              o.each((e, o) => {
                const d = m(o);
                ...
                n.loadImage(d[0], h || c, f, v, !1, () => {
                  if (null != n && n && (!n || n.params) && !n.destroyed) {
                    if (
                      ...
                      l.find(`.${r.preloaderClass}`).remove(),
                      n.params.loop && t)
                    ) {
        ...
        load() {
          const e = this,
            { $wrapperEl: t, params: n, slides: r, activeIndex: l } = e,
        ...
        getInterpolateFunction(e) {
          ...
          t.controller.spline ||
            (t.controller.spline = t.params.loop
              ? new le.LinearSpline(t.slidesGrid, e.slidesGrid)
              : new le.LinearSpline(t.snapGrid, e.snapGrid));
        },
        setTranslate(e, t) {
          const n = this,
          ...
          function d(e) {
            ...
            "slide" === n.params.controller.by &&
              ...
              (o && "container" !== n.params.controller.by) ||
                ...
                (o = (t - n.minTranslate()) * l + e.minTranslate())),
      ...
      const de = {
        ...
        setHistoryPopState() {
          const e = this;
          (e.history.paths = de.getPathValues()),
        ...
        setHistory(e, t) {
          ...
          (o && o.value === l) ||
            (n.params.history.replaceState
              ? c.history.replaceState({ value: l }, null, l)
              : c.history.pushState({ value: l }, null, l));
        },
        slugify: (text) =>
          text
            .toString()
        ...
        scrollToSlide(e, t, n) {
          ...
          if (t)
            for (let i = 0, l = r.slides.length; i < l; i += 1) {
              ...
              if (
                de.slugify(l.attr("data-history")) === t &&
                !l.hasClass(r.params.slideDuplicateClass)
              ) {
                const t = l.index();
                r.slideTo(t, e, n);
              }
      ...
      const ue = {
        setTranslate() {
          ...
          for (let i = 0; i < t.length; i += 1) {
            ...
            t.css({ opacity: l }).transform(`translate3d(${n}px, ${r}px, 0px)`);
          }
        },
        setTransition(e) {
          const t = this,
      ...
      const he = {
        setTranslate() {
          ...
          h.shadow &&
            (f
              ? ((w = n.find(".swiper-cube-shadow")),
                0 === w.length &&
                  ((w = m('<div class="swiper-cube-shadow"></div>')),
                  n.append(w)),
                w.css({ height: `${l}px` }))
              : ((w = t.find(".swiper-cube-shadow")),
                0 === w.length &&
                  ((w = m('<div class="swiper-cube-shadow"></div>')),
                  t.append(w))));
          for (let i = 0; i < r.length; i += 1) {
            ...
            t % 4 == 0
              ...
              : (t - 2) % 4 == 0
              ? ((o = c + 4 * l * c), (x = c))
              : (t - 3) % 4 == 0 && ((o = -c), (x = 3 * c + 4 * c * l)),
              d && (o = -o),
              f || ((w = o), (o = 0));
            const E = `rotateX(${f ? 0 : -n}deg) rotateY(${
              f ? n : 0
            }deg) translate3d(${o}px, ${w}px, ${x}px)`;
            if (
              (progress <= 1 &&
                progress > -1 &&
                ((y = 90 * t + 90 * progress),
          ...
          n.transform(
            `translate3d(0px,0,${x}px) rotateX(${
              e.isHorizontal() ? 0 : y
            }deg) rotateY(${e.isHorizontal() ? -y : 0}deg)`
          );
        },
        setTransition(e) {
          const t = this,
      ...
      const me = {
        setTranslate() {
          ...
          for (let i = 0; i < t.length; i += 1) {
            ...
            r.transform(
              `translate3d(${d}px, ${c}px, 0px) rotateX(${o}deg) rotateY(${l}deg)`
            );
          }
        },
        setTransition(e) {
      ...
      const fe = {
        setTranslate() {
          ...
          for (let i = 0, e = r.length; i < e; i += 1) {
            ...
            if (
              (e.transform(C),
              (e[0].style.zIndex = 1 - Math.abs(Math.round(n))),
              d.slideShadows)
            ) {
              let t = c
                  ? e.find(".swiper-slide-shadow-left")
              ...
              0 === t.length &&
                ...
                r.length && (r[0].style.opacity = -n > 0 ? -n : 0);
            }
          }
      ...
      const ge = {
        ...
        onThumbClick() {
          ...
          if (
            ...
            const n = e.slides
                .eq(t)
                .prevAll(`[data-swiper-slide-index="${l}"]`)
                .eq(0)
                .index(),
              r = e.slides
                .eq(t)
                .nextAll(`[data-swiper-slide-index="${l}"]`)
                .eq(0)
                .index();
          ...
          if (t.realIndex !== n.realIndex || o) {
            ...
            o && (d += "next" === c ? l : -1 * l),
              n.visibleSlidesIndexes &&
                n.visibleSlidesIndexes.indexOf(d) < 0 &&
